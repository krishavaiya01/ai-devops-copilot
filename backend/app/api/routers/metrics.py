...
SYSTEM_CPU_USAGE = Gauge("devops_copilot_system_cpu_usage_ratio", "Current CPU utilization ratio")

SYSTEM_MEMORY_USAGE = Gauge(
    "devops_copilot_system_memory_usage_bytes", "Current memory utilization in bytes"
)
