...
async def send_chat_message(
    ...
    try:
        ...
        history_records = (
            ...
            .filter(ChatMessage.session_id == chat_in.session_id)
        ...
        user_message = ChatMessage(
            session_id=chat_in.session_id, role="user", content=chat_in.content
        )
        db.add(user_message)
        db.commit()
        ...
        assistant_message = ChatMessage(
            session_id=chat_in.session_id, role="assistant", content=assistant_content
        )
